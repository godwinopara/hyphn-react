...
export default function Footer() {
	return (
		...
		// </footer>
		<footer>
			<div className="bg-primary-btn text-white px-6 py-16 ">
				<div className="max-w-desktop mx-auto md:grid md:grid-cols-2 items-center">
					<div className="mb-6">
						<img src={logo} alt="" />
					</div>
					<nav className="flex justify-between gap-x-5">
						<ul className="">
						...
						<ul>
							<li className="mb-2">BOOK WITH KENNETH NWOGU</li>
							<li>BOOK WITH DR LOLIYA IDONIBOYE</li>
						</ul>
					</nav>
				</div>
			</div>

			<div className="bg-primary text-center w-full px-6 py-10 flex items-center justify-center">
				<div className="w-full max-w-desktop mx-auto">
					<div className="flex items-center justify-center text-white lg:gap-x-8">
						<p className="hidden lg:block">Request Your Consultation Today</p>
						<a
							className="w-[246px] h-[56px]  flex items-center justify-center bg-primary-btn text-white"
					...
					<p className="text-white">© 2024 Integrative Wellness Center All Rights Reserved</p>
				</div>
			</div>
		</footer>
	);
