...
interface KenModalProps {
	toggleModal: boolean;
	closeModal: () => void;
}

export default function KenModal({ toggleModal, closeModal }: KenModalProps) {
	return (
		<>
			{toggleModal && (
				<div
						...
						<div className="h-auto lg:w-[800px]">
							<div className="flex items-center gap-x-5 justify-between p-5">
								<h2 className="font-medium text-lg xl:text-xl">
									Book online appointments With Ken Nwogu, Psychiatric Mental Health
									Nurse Practitioner
								</h2>
								<button
									onClick={closeModal}
							...
							<div className="w-full">
								<div className="h-[60vh]">
									<iframe
										title="Book online appointments With Ken Nwogu, Psychiatric Mental Health Nurse Practitioner"
										height="100%"
										width="100%"
										frameBorder="0"
