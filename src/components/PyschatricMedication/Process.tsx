    ...
    <div className={` bg-white `}>
      <Card reverse img={img}>
        <div className="flex flex-col gap-5 text-dark3 max-w-[464px] mx-auto">
          <h1 className="text-[32px] font-medium">Our Process:</h1>
          <p className="text-base ">
            If you struggle with any mental health symptoms such as anxiety or
            depression, and want to explore medication management alongside
            therapy as a solution,  we have a team of specialized providers to
            help! We prescribe a therapeutic medication schedule that will best
          ...
          <div className="grid grid-cols-1 gap-5">
            {data?.map((item) => (
              <div key={item.id} className="flex  gap-1">
                ...
                <span className="text-dark3 text-base max-w-[391px] mt-2">
                  {item.desc}
                </span>
              </div>
            ))}
      ...
      <div className="flex items-center justify-center h-24">
        <p className="text-dark3 text-32 font-medium">
