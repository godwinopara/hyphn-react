	...
	return (
		<section className="bg-white my-10">
			<div className="w-5/6 mx-auto flex flex-col gap-8 text-dark3">
				<h1 className="text-xl font-bold xl:text-[32px] text-center max-w-lg mx-auto xl:font-medium">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-7">
					{data.map((item: any) => (
						...
						>
							<p className="text-lg font-semibold xl:text-2xl xl:font-medium">{item.count}</p>
							<h1 className="text-xl font-bold xl:text-[32px] xl:font-medium">{item.title}</h1>
