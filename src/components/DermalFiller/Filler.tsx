...
export const Filler = (props: Props) => {
	return (
		<section className="bg-secondary2   py-28">
			<div className="px-6 xl:mb-0 xl:w-5/6 mx-auto xl:flex xl:items-center xl:justify-between md:px-14 xl:px-24 xl:py-14">
				{data.map((item: any) => (
					<div key={item.id} className="flex mb-10 xl:mb-0 flex-col gap-5 text-dark3 max-w-md">
						<h1 className="font-bold text-xl xl:text-32 xl:font-medium">{item.title}</h1>
